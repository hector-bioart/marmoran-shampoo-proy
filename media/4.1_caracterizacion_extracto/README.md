...
| `extracto_acuoso_estabilizado.jpg` | Muestra de 6 L de extracto tras la adición de conservadores. Se observa la coloración verde amarillenta y la formación de espuma persistente, indicador visual de la presencia de saponinas. | Corresponde a la **Figura 4.1.1** del reporte. |
