# Evidencia Visual: Propiedades Fisicoquímicas y de Desempeño (4.4)

Este directorio contiene el registro fotográfico de las evaluaciones instrumentales y las pruebas de desempeño aplicadas a las formulaciones de *Agave marmorata* y su respectiva referencia comercial.

## Relación de Evidencia Técnica

| Archivo | Descripción del Ensayo | Observación Metodológica |
| :--- | :--- | :--- |
| [`champu_comercial_a_f4.jpg`](./champu_comercial_a_f4.jpg) | Disposición experimental para la medición de pH. | Se documenta la calibración del equipo (soluciones buffer) y el contraste visual (color y turbidez) entre el champú comercial de referencia y las variantes experimentales (F1-F4). |
