...
| :--- | :--- | :--- |
| [`4.1a_grafica_ph.py`](./4.1a_grafica_ph.py) | Genera un gráfico de barras con barras de error para el pH (media ± desviación estándar). | **Capítulo 4 (Resultados):** Figura 4.2. |
| [`4.1b_grafica_sdt_ce.py`](./4.1b_grafica_sdt_ce.py) | Genera un gráfico de barras comparativo entre los Sólidos Disueltos Totales (SDT) y la Conductividad Eléctrica. | **Anexo B:** Scripts de procesamiento de datos |
